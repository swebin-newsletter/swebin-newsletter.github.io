...
`)}const V="https://swebin-sveltia-auth.swebin-newsletter.workers.dev",f={owner:"swebin-dev",repo:"swebin-newsletter",ref:"main"},Y="swebin.newsletter@gmail.com",u=document.getElementById("manage-status"),h=document.getElementById("manage-dashboard"),c=document.getElementById("login-btn"),d=document.getElementById("logout-btn"),o=document.getElementById("account-label");function l(e){u.innerHTML="";const t=document.createElement("p");t.textContent=e,u.appendChild(t)}async function y(e){if(l("불러오는 중입니다..."),!await k(f,e)){v(),c.hidden=!1,d.hidden=!0,o.hidden=!0,l("이 저장소에 대한 접근 권한이 없는 계정입니다. 권한이 있는 GitHub 계정으로 다시 로그인해 주세요.");return}const s=await B(e);s&&(o.textContent=`${s}(으)로 로그인됨`,o.hidden=!1);try{const n=await N(f,e,window.location.origin);h.innerHTML=J(n,window.location.origin,Y),h.hidden=!1,c.hidden=!0,d.hidden=!1,l(""),u.hidden=!0}catch{l("불러오는 중 오류가 발생했습니다. 다시 시도해 주세요.")}}c.addEventListener("click",async()=>{c.disabled=!0,l("GitHub 로그인 창을 여는 중입니다...");try{const e=await M({workerBaseUrl:V});await y(e)}catch(e){l(e instanceof Error?e.message:"로그인에 실패했습니다.")}finally{c.disabled=!1}});d.addEventListener("click",()=>{v(),h.hidden=!0,c.hidden=!1,d.hidden=!0,o.hidden=!0,u.hidden=!1,l("로그아웃했습니다. 다시 보려면 로그인해 주세요.")});const m=R();m&&(d.hidden=!1,c.hidden=!0,y(m));
